...
<tr>
    ...
    <th>FATHER'S NAME : </th><td> <input type="text" name="ffn"  placeholder="FIRST NAME" id="faname"></td>
        ...
        <tr>
            <th>STATE:</th> <td><input type="text" name="state" placeholder="STATE" id="state" /></td>
        <th>PIN CODE:</th> <td><input type="text" name="pin" max="6" id="pin" /></td></tr>
        <tr>
        ...
        <tr><th>RE-ENTER PASSWORD:</th> <td><input type="password" name="rpss" id="rpass" ></td></tr>
                    ...
                    <center ><input type="submit" name="submit" value="SUBMIT" class="submit" style="height: 30px;
    width: 80px;
    font-size: 15px;
    font-weight: bold;
    border: 1px solid;
